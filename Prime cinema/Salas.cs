...
namespace Prime_cinema
{
    public partial class Salas : Form
    {
        ...
        private void btnAgragar_Click(object sender, EventArgs e)
        {
            ...
            string archivo = @"../Salas/" + txtNumero.Text + ".txt";
        ...
        private void Salas_Load(object sender, EventArgs e)
        {
            ...
            string[] archivos1 = Directory.GetFiles(@"../Sucursales/", "*.txt");
            ...
            string[] archivos2 = Directory.GetFiles(@"../Peliculas/", "*.txt");
