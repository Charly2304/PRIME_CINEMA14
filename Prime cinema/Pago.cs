...
namespace Prime_cinema
{
    public partial class Pago : Form
    {
        ...
        private void Pago_Load(object sender, EventArgs e)
        {
            ...
            string[] archivos = Directory.GetFiles(@"../Salas/", "*.txt");
            ...
            string[] archivos1 = Directory.GetFiles(@"../Formato/", "*.txt");
        ...
        private void comFormato_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (comFormato.SelectedItem.ToString() == "3D")
            {
                ...
                string archivo = @"../Peliculas/" + comPelicula.SelectedItem.ToString() + ".txt";
        ...
        private void BtnBvtaca_Click(object sender, EventArgs e)
        {
            ...
            int numVentas = Directory.GetFiles(@"../Ventas/")
            ...
            using (StreamWriter writer = new StreamWriter($@"../Ventas/{nombreArchivo}", true))
            {
